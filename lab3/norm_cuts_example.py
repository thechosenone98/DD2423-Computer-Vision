...
def norm_cuts_example():
    ...
    for i in [1, 10, 20, 30, 40]:
        segm = norm_cuts_segm(I, i, radius, ncuts_thresh, min_area, max_depth)
        ...
        plt.axis('off')
        plt.show()
    # img.save('/Users/zach-mcc/Documents/Programming/Python/DD2423-Computer-Vision/lab3/result/normcuts1.png')
